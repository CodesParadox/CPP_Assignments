...
namespace ariel{
    ...
    class DevelopmentCard {
        ...
        public:
            ...
            friend ostream& operator<<(ostream &out, const DevelopmentCard &card);
    };
    ...
    class PromotionCard : public DevelopmentCard{
        public:
            ...
            virtual void use() = 0;     // make func and class abstract - must implement
            friend ostream& operator<<(ostream &out, const PromotionCard &card);
    };
    ...
    class RoadBuildingCard : public PromotionCard {
        public:
            ...
            void use() override;
            friend ostream& operator<<(ostream &out, const RoadBuildingCard &card);
    };
    ...
    class YearOfPlentyCard : public PromotionCard {
        public:
            ...
            void use() override;
            friend ostream &operator<<(ostream &out, const YearOfPlentyCard &card);
    };
    ...
    class MonopolyCard : public PromotionCard {
        public:
            ...
            void use() override;
            friend ostream &operator<<(ostream &out, const MonopolyCard &card);
    };
    ...
    class KnightCard : public DevelopmentCard{
        public:
            ...
            void use() override;
            friend ostream &operator<<(ostream &out, const KnightCard &card);
    };
    ...
    class VictoryPointCard : public DevelopmentCard{
        public:
            ...
            void use() override;
            friend ostream &operator<<(ostream &out, const VictoryPointCard &card);
    };
}
